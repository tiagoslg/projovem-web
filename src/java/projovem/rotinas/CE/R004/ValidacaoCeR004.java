 ...
 */
public class ValidacaoCeR004 {

    public static boolean validaRotina(CeRotina004 rotina) {
        ...
        if (rotina.getClassificacaoLocal() == null || (rotina.getClassificacaoLocal() != null && rotina.getClassificacaoLocal().isEmpty())) {
            ...
            if (rotina.getClassificacaoLocal() == null || (rotina.getClassificacaoLocal() != null && rotina.getClassificacaoLocal().isEmpty())) {
                if (rotina.getClassificacaoLocalComplemento() == null && rotina.getClassificacaoLocal().equals("6")) {
                    rotinaValida = false;
        ...
        if (rotina.getFormaArmazenamentoFichas() == null || (rotina.getFormaArmazenamentoFichas() != null && rotina.getFormaArmazenamentoFichas().isEmpty())) {
            ...
            if (rotina.getFormaArmazenamentoFichas() == null || (rotina.getFormaArmazenamentoFichas() != null && rotina.getFormaArmazenamentoFichas().isEmpty())) {
                if (rotina.getFormaArmazenamentoFichasComplemento() == null && rotina.getFormaArmazenamentoFichas().equals("outro")) {
                    rotinaValida = false;
