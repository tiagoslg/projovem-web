...
public class ValidacaoArcosOcupacionais {
    ...
    public static boolean validaRotina(Rotina006ArcosOcupacionais rotina) {
        ...
        if (!rotina.getQ1Aarco().equals("semPrevisao")) {
            ...
            rotina.setQ4(null);
            rotina.setQ9InicioAtividades(null);
            rotina.setQ9Fechado(null);
            rotina.setQ9InicioAtividades(null);
            rotina.setQ9FinalAtividades(null);
            rotina.setQ14(null);
            rotina.setQ19(null);
            rotina.setQ24Educadores(null);
            rotina.setQ24Alunos(null);
            rotina.setQ29(null);
            rotina.setQ34(null);
            rotina.setQ39(null);
            rotina.setQ44(null);
