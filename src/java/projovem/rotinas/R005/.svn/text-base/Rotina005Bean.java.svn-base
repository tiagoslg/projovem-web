 ...
 * @author admprojovem
 */
public class Rotina005Bean implements Serializable {
    ...
    private Rotina005 rotina = new Rotina005();
    private Rotina005DAO rotinaDao = new Rotina005DAO();
    private Nucleo nucleoEscolhido = new Nucleo();
    private String usuarioResponsavel;
    private String cpfResponsavel;


    /** Creates a new instance of Rotina005Bean */
    public Rotina005Bean() {
    }
    ...
    public String salvarRotina() {
        ...
        //rotinaDao.saveRotina005(rotina, emf, utx);

        String retorno = "";
        if (ValidacaoR005.validaRotina(rotina)) {
            try {
                rotinaDao.saveRotina005(rotina, emf, utx);
                ...
                ex.printStackTrace();
                Logger.getLogger(Rotina005Bean.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public Rotina005 getRotina() {
        return rotina;
    }

    public void setRotina(Rotina005 rotina) {
        this.rotina = rotina;
    }
